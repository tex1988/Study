...
*/
public class InnerClassInheritanceTask2 implements Action {
    ...
    public InnerClassInheritanceTask2(int param) {
        this.param = param;
    }
    ...
    public static void main(String[] args) {
        InnerClassInheritanceTask2 solution = new InnerClassInheritanceTask2(5);
        solution.someAction();
        System.out.println("Count of created Action objects is " + countActionObjects);

        solution = new InnerClassInheritanceTask2(-1);
        solution.someAction();
        System.out.println("Count of created Action objects is " + countActionObjects);
    }
}